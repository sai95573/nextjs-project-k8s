...
import { usePostLoginMutation } from "@/store/slice/auth/loginSlice";
...
const SignIn: React.FC = () => {
  ...
  async function onSubmit({ email, password }: InputProps) {
    try {
      await loginMutation({
        email: email,
        password: password,
        ...
        console.log("res", res);
        Cookies.set("sc_token", res?.data?.token);
        Cookies.set("sc_user_id", res?.data?.userId);
      ...
      console.log("Please enter valid user and password");
    }
  }
  ...
  return (
    <DefaultLayout>
      ...
      >
        <div className="flex h-screen w-9/12 flex-wrap items-center justify-center rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium"> Sign In to</span>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="" // Add padding to make space for the icon inside the input
                    />
                    <span
                      onClick={handleShowPassword}
                      // className="absolute right-3 top-1/2 -translate-y-1/2 transform cursor-pointer"
                      className="absolute right-3 top-6 -translate-y-1/2 transform cursor-pointer"
                    >
                      {showPassword ? (
